...
def holberton() -> str:
    ...
    user_tzone = get_timezone()
    user_locale = get_locale()
    if user_locale == 'en':
        dtime = 'MMMM d, yyyy, hh:mm:ss a'
    else:
        dtime = 'MMMM d yyyy hh:mm:ss a'
    user_time = format_datetime(datetime.now(timezone(user_tzone)), dtime,
                                tzinfo=user_tzone, locale=user_locale)
    return render_template('index.html', current_time=user_time)
